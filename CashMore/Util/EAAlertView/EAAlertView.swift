...
open class EAAlertView: UIViewController {
    ...
    public struct EAAppearance {
        ...
        public init(kDefaultShadowOpacity: CGFloat = 0.7,
                    ...
                    kWindowWidth: CGFloat = UIScreen.main.bounds.width*0.88 ,
                    ...
                    kTitleFont: UIFont = UIFont.boldSystemFont(ofSize: 32),
                    ...
                    buttonCornerRadius: CGFloat = 6.0,
                    ...
                    buttonsLayout: EAAlertButtonLayout = .vertical,
